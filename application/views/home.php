...
<!-- <div class="wrap">
    <div class="aligncenter header_elections"><img src="http://cdn.banglatribune.com/contents/uploads/media/2019/03/31/b92de670fd57d0ebe8c0ff40991d6a75-5ca08ae4155e7.jpg"></div>
    <div class="second_info">
        <div class="e_row clearfix" style="text-align:center;">মোট উপজেলা: ১০৭, স্থগিত <span class="postponed">১</span></div>
    ...
    <div class="first_info clearfix">
        <div class="total_vote">বিনা প্রতিদ্বন্দ্বিতায় ২৪ &#40;আ.লীগ&#41;</div>
    </div>
</div> -->
</div>
<!-- <script src="http://service.banglatribune.com/vote_count"></script> -->
    <!--Top Stories-->
    <div class="sec_left">
        <div class="article LeftalignedImg TopStoriesPage">
            <div class="red_gradient top">
                        ...
                        <li>
                            <?php if ($i == 1) { ?>
                                <div class="imgContainer">
                                    <a href="<?php echo url_format_fnc($value['web_url']); ?>"><img src="<?php echo media_image_resize($value['content_thumbnail_image'],320,180); ?>" alt="<?php echo $value['title']; ?>" ></a>
                                </div>
                            <?php } else { ?>
                                <div class="imgContainer">
                                    <a href="<?php echo url_format_fnc($value['web_url']); ?>"><img src="<?php echo media_image_resize($value['content_thumbnail_image'],170,96); ?>" alt="<?php echo $value['title']; ?>" ></a>
                                </div>
                            <?php } ?>
                            <div class="text_container">
                                ...
                                <div class="summery">
                                    <a href="<?php echo url_format_fnc($value['web_url']); ?>"><?php echo limit_words($value['excerpt'], 8); ?><span class="excerpt_more" title="বিস্তারিত"><span>বিস্তারিত</span></span></a>
                                </div>
                            </div>
                        </li>
                        <?php
                ...
                foreach ($column['data'] as $key => $value) {
                    ...
                    <div class="left_item">
                        <div class="leftImg_title">
                            <div class="imgContainer leftImg"><a href="<?php echo url_format_fnc($value['web_url']); ?>"><img class="thumb" src="<?php echo media_image_resize($value['content_thumbnail_image_square'],51,51); ?>" alt=""></a></div>
                            <h2 class="title_holder">
                                <a href="<?php echo url_format_fnc($value['web_url']); ?>">
                                    <span class="subtitle"><?php echo $value['subtitle']; ?></span>
                                    <span class="title"><?php echo $value['title']; ?></span>
